...
struct NetWorkModel {
    ...
    func getSeries(with id: Int) -> URLRequest {
            let urlBaseseries = "https://gateway.marvel.com/v1/public/characters/\(id)/series?ts=1&apikey=c4f3f162d0e23b27093e8929b8af94b6&hash=ec2facffc6252f40de0ae675c55244fb"
